...
| ArgoCD apps stuck in `OutOfSync` with "repository not accessible" | aks-gitops URL wrong or repo private without creds | Verify https://github.com/nanohype/aks-gitops loads anonymously |
